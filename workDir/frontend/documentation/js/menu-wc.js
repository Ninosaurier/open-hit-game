                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/IdentityHttpParameterCodec.html" data-type="entity-link" >IdentityHttpParameterCodec</a>
                            </li>
                            <li class="link">
                                <a href="classes/OpenApiHttpParams.html" data-type="entity-link" >OpenApiHttpParams</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CreateLobbyRequestV1Dto.html" data-type="entity-link" >CreateLobbyRequestV1Dto</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CreateLobbyResponseDto.html" data-type="entity-link" >CreateLobbyResponseDto</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/CreateLobbyResponseV1Dto.html" data-type="entity-link" >CreateLobbyResponseV1Dto</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Param.html" data-type="entity-link" >Param</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ParamEntry.html" data-type="entity-link" >ParamEntry</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ParamOptions.html" data-type="entity-link" >ParamOptions</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
